...
(function(document, $) {
    ...
    $(document).on("foundation-contentloaded", function(e) {
        ...
        showHide($(".cq-dialog-dropdown-tab-showhide", e.target));
    });

    $(document).on("selected", ".cq-dialog-dropdown-tab-showhide", function(e) {
        showHide($(this));
    });
   ...
   function showHide(el){
       ...
       el.each(function(i, element) {
           ...
           if (widget) {
               ...
               var target = $(element).data("cqDialogDropdownTabShowhideTarget");
